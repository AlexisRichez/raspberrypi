...
#docker create --net host --name jeedom-server -v /opt/jeedom/html:/var/www/html -e ROOT_PASSWORD=password -e APACHE_PORT=9080 -e SSH_PORT=9022 -e MODE_HOST=1 --device $RFXCOM:/dev/ttyUSB0 --device $USB2:/dev/ttyACM0 --restart always jeedom/jeedom:V4-stable
